...
local Dropdown = MainTab:CreateDropdown({
   ...
   CurrentOption = "Infinite yeild",
   MultipleOptions = false, -- Only one option can be selected at a time
   Flag = "DropdownChoose", -- A flag is the identifier for the configuration file, make sure every element has a different flag if you're using configuration saving to ensure no overlaps
   Callback = function(Option)
      if Option == "Infinite yeild" then
         loadstring(game:HttpGet("https://raw.githubusercontent.com/ttwizz/infiniteyield/master/source.lua", true))()
      elseif Option == "Dark dex" then
